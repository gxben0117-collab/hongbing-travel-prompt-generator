...
const failedJobsPath = path.join(outDir, "lanbao_failed_jobs.json");
...
console.log(`Lanbao batch chunk finished. Generated=${generated} Skipped=${skipped} Failed=${failed} Total=${jobs.length}`);
if (failed > 0) {
  process.exit(1);
}
